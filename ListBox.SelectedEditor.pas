...
begin
  self.ShowHint := true;
  self.Padding.Left := 50;
  self.Padding.Top := 50;
  self.Padding.Right := 50;
...
{$IFDEF DEBUG}
  ...
  btn.Caption := 'Item 01';
  lstLeft.AddItem(btn.Caption, btn);
...
begin
  btnCancel.Left := self.ClientWidth - self.Padding.Left - self.Padding.Right -
    btnCancel.Width;
